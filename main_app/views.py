...
def render_main():
    ...
    return flask.render_template("main.html", nickname=nickname, email=email, password=password, profile_icon=profile_icon, is_authenticated=flask_login.current_user.is_authenticated)
